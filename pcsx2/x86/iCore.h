...
extern __tls_emit std::shared_ptr<x86Emitter::xForwardJumpBase> j8Ptr[32];		// depreciated item.  use local u8* vars instead.
extern __tls_emit std::shared_ptr<x86Emitter::xForwardJumpBase> j32Ptr[32];		// depreciated item.  use local u32* vars instead.
