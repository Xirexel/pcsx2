...
namespace MediaStream
{
    public class RTSPStream
    {
        ...
        private static RTSPStream m_Instance = null;
        
        private Action<Action<IntPtr, uint>> m_RegisterAction = null;

        public static RTSPStream Instance { get { if (m_Instance == null) m_Instance = new RTSPStream(); return m_Instance; } }
...
0x1610, 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71);
        ...
        private RTSPStream()
        {
            ...
            try
            {
                mCaptureManager = new CaptureManager(@"C:\Users\Evgeny Pereguda\Documents\CaptureManager\CaptureManager-Commercial\CaptureManager\Debug\CaptureManager.dll");
            }
            catch (Exception)
            {
