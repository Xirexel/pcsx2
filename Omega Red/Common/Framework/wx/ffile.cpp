...
wxFFile::wxFFile(const wxString& src, const wxChar* mode)
{
}
...
size_t wxFFile::Write(const char* data, size_t length)
{
	return 0;
}

size_t wxFFile::Write(const uint8_t* data, size_t length)
{
	return 0;
}

size_t wxFFile::Read(uint8_t* data, size_t length)
{
	return 0;
}

void wxFFile::Seek(int a_seek)
{
}

bool wxFFile::IsOpened()
{
	return false;
}