...
void __cdecl SndBuffer::UpdateTempoChangeAsyncMixing(void) {}

void __cdecl SndBuffer::timeStretchUnderrun(void) {}

void __cdecl SndBuffer::soundtouchCleanup(void) {}

void __cdecl SndBuffer::soundtouchClearContents(void) {}

void __cdecl SndBuffer::soundtouchInit(void) {}
...
StereoOut16 StereoOut32::DownSampleClamp() const
{
    return StereoOut16(
        Left,
        Right);
