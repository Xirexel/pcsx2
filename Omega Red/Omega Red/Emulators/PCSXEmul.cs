    ...
    class PCSXEmul : IEmul
    {
        ...
        private PCSXEmul()
        {
            ...
            try
            {
                ...
                using (var lStream = l_ExecutingAssembly.GetManifestResourceStream("Omega_Red.Modules.AnyCPU.PCSXEmul.dll"))
                {
                    if (lStream == null)
                        return;
        ...
        public EmulStartState start(IsoInfo a_IsoInfo, IntPtr a_SharedHandle)
        {
            ...
            do
            {
                ...
                if (m_current_iso_file == a_IsoInfo.FilePath && m_current_bios_file == 
                    (Emul.Instance.BiosInfo == null? "": Emul.Instance.BiosInfo.GameType == GameType.PS1? Emul.Instance.BiosInfo.FilePath: ""))
                {
                ...
                m_current_bios_file = Emul.Instance.BiosInfo == null ? "" : Emul.Instance.BiosInfo.GameType == GameType.PS1 ? Emul.Instance.BiosInfo.FilePath : "";
