...
static ISimpleAudioVolume *s_audioVolume_ = nullptr;

void setVolume(float a_level)
{
    if (s_audioVolume_ != nullptr)
        s_audioVolume_->SetMasterVolume(a_level, NULL);
}
...
public:
    ...
    ISimpleAudioVolume *audioVolume_ = nullptr;
...
bool WASAPIAudioThread::InitAudioDevice() {
    ...
    hresult = audioInterface_->GetService(__uuidof(ISimpleAudioVolume), (void **)&audioVolume_);

	s_audioVolume_ = audioVolume_;
