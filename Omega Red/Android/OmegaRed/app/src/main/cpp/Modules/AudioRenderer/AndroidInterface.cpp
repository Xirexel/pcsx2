...
Java_com_evgenypereguda_omegared_PCSX2_Modules_AudioRenderer_GetPCSX2LibAPI(JNIEnv *env,
																			  jobject instance) {
...
Java_com_evgenypereguda_omegared_PCSX2_Modules_AudioRenderer_Execute(JNIEnv *env, jobject instance,
																	 jstring aCommand) {
