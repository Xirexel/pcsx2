...
Java_com_evgenypereguda_omegared_PCSX2_Modules_Pad_GetPCSX2LibAPI(JNIEnv *env,
																			  jobject instance) {
...
Java_com_evgenypereguda_omegared_PCSX2_Modules_Pad_Execute(JNIEnv *env, jobject instance,
																	 jstring aCommand) {
