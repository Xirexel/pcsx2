...
Java_com_evgenypereguda_omegared_PCSX2_Modules_MemoryCard_GetPCSX2LibAPI(JNIEnv *env,
																			  jobject instance) {
...
Java_com_evgenypereguda_omegared_PCSX2_Modules_MemoryCard_Execute(JNIEnv *env, jobject instance,
																	 jstring aCommand) {
