...
void xImplSimd_DestRegSSE::operator()(const xRegisterSSE &to, const xIndirectVoid &from) const {


    Arm64Gen::ARM64Reg src = Arm64JitConstants::SCRATCH2_64;
    ...
    if(this->Opcode == 84)
    {
        g_Emitter.MOVI2R(Arm64Gen::ARM64Reg::X26, -1);

        g_Emitter.MOVI2R(Arm64JitConstants::SCRATCH1_64, (u64)to.getData());

        g_Emitter.LDP(Arm64Gen::INDEX_UNSIGNED, Arm64Gen::ARM64Reg::X21, Arm64Gen::ARM64Reg::X22, Arm64JitConstants::SCRATCH1_64, 0);

        g_Emitter.LDP(Arm64Gen::INDEX_UNSIGNED, Arm64Gen::ARM64Reg::X23, Arm64Gen::ARM64Reg::X24, src, 0);


        for (int i = 0; i < 2; ++i) {

            Arm64Gen::ARM64Reg l_Dest = (Arm64Gen::ARM64Reg)((u32)Arm64Gen::ARM64Reg::X21 + i);

            Arm64Gen::ARM64Reg l_Src = (Arm64Gen::ARM64Reg)((u32)Arm64Gen::ARM64Reg::X23 + i);

            g_Emitter.AND(l_Dest, l_Dest, l_Src);

        }

        g_Emitter.STP(Arm64Gen::INDEX_UNSIGNED, Arm64Gen::ARM64Reg::X21, Arm64Gen::ARM64Reg::X22, Arm64JitConstants::SCRATCH1_64, 0);
    }
    else
        throw L"Unimplemented!!!";
}

void xImplSimd_DestRegImmSSE::operator()(const xRegisterSSE &to, const xRegisterSSE &from, u8 imm) const
{
    if(Prefix == 0x66)
    {
        if(Opcode == 0x70)
...
//        Destination[96..127] = (Source >> (Order[6..7] * 32))[0..31];
            ...
            g_Emitter.MOVI2R(Arm64JitConstants::SCRATCH2_64, (u64)from.getData());



            g_Emitter.LDP(Arm64Gen::INDEX_UNSIGNED, Arm64Gen::ARM64Reg::X21, Arm64Gen::ARM64Reg::X22, Arm64JitConstants::SCRATCH1_64, 0);

            g_Emitter.LDP(Arm64Gen::INDEX_UNSIGNED, Arm64Gen::ARM64Reg::X23, Arm64Gen::ARM64Reg::X24, Arm64JitConstants::SCRATCH2_64, 0);


            Arm64Gen::ARM64Reg l_Dest = Arm64Gen::ARM64Reg::X21;

            for (int i = 0; i < 2; ++i) {

                u32 l_offsetReg = (imm >> (i * 2)) & 0xF;

                for (int quad = 0; quad < 2; ++quad) {

                    u32 l_offset = (l_offsetReg >> (quad * 2)) & 0x3;

                    switch(l_offset)
                    {
                        case 0:
                            g_Emitter.BFI(l_Dest, Arm64Gen::ARM64Reg::X23,  quad * 32, 32);
                            break;
                        case 1:
                            g_Emitter.LSR(Arm64JitConstants::SCRATCH2_64, Arm64Gen::ARM64Reg::X23, 32);
                            g_Emitter.BFI(l_Dest, Arm64JitConstants::SCRATCH2_64,  quad * 32, 32);
                            break;
                        case 2:
                            g_Emitter.BFI(l_Dest, Arm64Gen::ARM64Reg::X24,  quad * 32, 32);
                            break;
                        case 3 :
                            g_Emitter.LSR(Arm64JitConstants::SCRATCH2_64, Arm64Gen::ARM64Reg::X24, 32);
                            g_Emitter.BFI(l_Dest, Arm64JitConstants::SCRATCH2_64,  quad * 32, 32);
                            break;
                    }
                ...
                l_Dest = Arm64Gen::ARM64Reg::X22;
            }

            g_Emitter.STP(Arm64Gen::INDEX_UNSIGNED, Arm64Gen::ARM64Reg::X21, Arm64Gen::ARM64Reg::X22, Arm64JitConstants::SCRATCH1_64, 0);

        }else if(Opcode == 0x0c3a){
...
//            DEST[MAXVL-1:128] (Unmodified)
            ...
            Arm64Gen::ARM64Reg l_Src = Arm64Gen::ARM64Reg::X23;
            ...
            for (int i = 0; i < 2; ++i) {
                ...
                for (int quad = 0; quad < 2; ++quad) {
                    ...
                    u32 l_offset = (l_offsetReg >> quad) & 0x1;

                    if(l_offset != 0)
                    {
                        g_Emitter.LSR(Arm64JitConstants::SCRATCH2_64, l_Src, quad * 32);
                        g_Emitter.BFI(l_Dest, Arm64JitConstants::SCRATCH2_64,  quad * 32, 32);
                    }
                }
...
void xImplSimd_DestRegEither::operator()(const xRegisterSSE &to, const xRegisterSSE &from) const
{
    if(Prefix == 0x66)
    {
        if(Opcode == 0xdb)
        {
            ...
            g_Emitter.AND(Arm64Gen::ARM64Reg::X21, Arm64Gen::ARM64Reg::X21, Arm64Gen::ARM64Reg::X23);

            g_Emitter.AND(Arm64Gen::ARM64Reg::X22, Arm64Gen::ARM64Reg::X22, Arm64Gen::ARM64Reg::X24);
            ...
            g_Emitter.ORR(Arm64Gen::ARM64Reg::X21, Arm64Gen::ARM64Reg::X21, Arm64Gen::ARM64Reg::X23);

            g_Emitter.ORR(Arm64Gen::ARM64Reg::X22, Arm64Gen::ARM64Reg::X22, Arm64Gen::ARM64Reg::X24);
...
void xImplSimd_DestRegEither::operator()(const xRegisterSSE &to, const xIndirectVoid &from) const  {
...
//            else Destination[96..127] = 0;
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            g_Emitter.CMP(
                    (Arm64Gen::ARM64Reg)(l_Dest - Arm64Gen::ARM64Reg::X0),
                    (Arm64Gen::ARM64Reg)(l_Src - Arm64Gen::ARM64Reg::X0)
            );

            g_Emitter.CSEL(Arm64Gen::ARM64Reg::W25, Arm64Gen::ARM64Reg::W26, Arm64Gen::ARM64Reg::WZR, CCFlags::CC_EQ);

            g_Emitter.BFI(l_Dest, Arm64Gen::ARM64Reg::X25,  0, 32);



            g_Emitter.LSR(Arm64Gen::ARM64Reg::X25, l_Dest, 32);

            g_Emitter.LSR(Arm64Gen::ARM64Reg::X12, l_Src, 32);

            g_Emitter.CMP(
                    (Arm64Gen::ARM64Reg)(Arm64Gen::ARM64Reg::X25 - Arm64Gen::ARM64Reg::X0),
                    (Arm64Gen::ARM64Reg)(Arm64Gen::ARM64Reg::X12 - Arm64Gen::ARM64Reg::X0)
            );

            g_Emitter.CSEL(Arm64Gen::ARM64Reg::W25, Arm64Gen::ARM64Reg::W26, Arm64Gen::ARM64Reg::WZR, CCFlags::CC_EQ);

            g_Emitter.BFI(l_Dest, Arm64Gen::ARM64Reg::X25,  32, 32);
        }
...
//        DEST[MAXVL-1:128] (Unmodified)
            ...
            for (int i = 0; i < 2; ++i) {
                ...
                g_Emitter.LSL(Arm64JitConstants::SCRATCH2_64, l_Dest, imm8);

                g_Emitter.BFI(l_Dest, Arm64JitConstants::SCRATCH2_64,  0, 32);



                g_Emitter.LSR(Arm64JitConstants::SCRATCH2_64, l_Dest, 32);

                g_Emitter.LSL(Arm64JitConstants::SCRATCH2_64, Arm64JitConstants::SCRATCH2_64, imm8);

                g_Emitter.BFI(l_Dest, Arm64JitConstants::SCRATCH2_64,  32, 32);
...
//                DEST[MAXVL-1:128] (Unmodified)
            ...
            for (int i = 0; i < 2; ++i) {
                ...
                g_Emitter.UBFX(Arm64JitConstants::SCRATCH2_64, l_Dest,  0, 32);

                g_Emitter.LSR(Arm64JitConstants::SCRATCH2_64, Arm64JitConstants::SCRATCH2_64, imm8);

                g_Emitter.BFI(l_Dest, Arm64JitConstants::SCRATCH2_64,  0, 32);



                g_Emitter.LSR(Arm64Gen::ARM64Reg::X23, l_Dest, 32);

                g_Emitter.UBFX(Arm64JitConstants::SCRATCH2_64, Arm64Gen::ARM64Reg::X23,  0, 32);
...
void xImplSimd_Shuffle::PS(const xRegisterSSE &to, const xRegisterSSE &from, u8 selector) const
{
    ...
    for (int i = 0; i < 2; ++i) {
        ...
        for (int half = 0; half < 2; ++half) {
            ...
            u8 l_index = (selector >> ( i * 4 + half * 2)) & 0x3;

            switch(l_index)
            {
                case 0:
                {
                    g_Emitter.BFI(l_Dest, Arm64Gen::ARM64Reg::X23,  half * 32, 32);
                }
                    break;

                case 1:
                {
                    g_Emitter.LSR(Arm64Gen::ARM64Reg::X25,
                                  Arm64Gen::ARM64Reg::X23,
                                  32);

                    g_Emitter.BFI(l_Dest, Arm64Gen::ARM64Reg::X25,  half * 32, 32);
                }
                    break;

                case 2:
                {
                    g_Emitter.BFI(l_Dest, Arm64Gen::ARM64Reg::X24,  half * 32, 32);
                }
                    break;
...
void xImplSimd_MovHL_RtoR::PS(const xRegisterSSE &to, const xRegisterSSE &from) const {
    ...
    if(Opcode == 0x12)
    {
        ...
        g_Emitter.STP(Arm64Gen::INDEX_UNSIGNED, Arm64Gen::ARM64Reg::X24, Arm64Gen::ARM64Reg::ZR, Arm64JitConstants::SCRATCH1_64, 0);
...
void xImplSimd_MoveSSE::operator()(const xRegisterSSE &to, const xRegisterSSE &from) const
{
    if (to != from)
    {
        ...
        g_Emitter.STP(Arm64Gen::INDEX_UNSIGNED, Arm64Gen::ARM64Reg::X23, Arm64Gen::ARM64Reg::X24, Arm64JitConstants::SCRATCH1_64, 0);
    }
}
...
void xImplSimd_MoveSSE::operator()(const xRegisterSSE &to, const xIndirectVoid &from) const
{
    ...
    g_fp.LDR(128, Arm64Gen::ARM64Reg::Q0, src);
    g_fp.STR(128, Arm64Gen::ARM64Reg::Q0, Arm64JitConstants::SCRATCH1_64);
}
...
void xImplSimd_MoveSSE::operator()(const xIndirectVoid &to, const xRegisterSSE &from) const
{
    ...
    setAddress(target, to);

    g_Emitter.MOVI2R(Arm64JitConstants::SCRATCH1_64, (u64)from.getData());

    g_fp.LDR(128, Arm64Gen::ARM64Reg::Q0, Arm64JitConstants::SCRATCH1_64);
    g_fp.STR(128, Arm64Gen::ARM64Reg::Q0, target);
}
...
void xImplSimd_PMove::BD(const xRegisterSSE &to, const xIndirect32 &from) const {

//        Destination[0..31] = Source[0..15];
//        Destination[32..63] = Source[16..31];
//        Destination[64..95] = Source[32..47];
//        Destination[96..127] = Source[48..63];
    ...
    g_Emitter.LDR(Arm64Gen::ARM64Reg::X23, src);


    if(this->OpcodeBase == 0x2038)
    {
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            g_Emitter.SXTB(l_Dest, Arm64Gen::ARM64Reg::X23);

            g_Emitter.LSR(Arm64Gen::ARM64Reg::X23, Arm64Gen::ARM64Reg::X23, 8);

            g_Emitter.SXTB(Arm64JitConstants::SCRATCH2_64, Arm64Gen::ARM64Reg::X23);
    ...
    if(this->OpcodeBase == 0x3038)
    {
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            g_Emitter.UXTB(l_Dest, Arm64Gen::ARM64Reg::X23);

            g_Emitter.LSR(Arm64Gen::ARM64Reg::X23, Arm64Gen::ARM64Reg::X23, 8);

            g_Emitter.UXTB(Arm64JitConstants::SCRATCH2_64, Arm64Gen::ARM64Reg::X23);
...
void xImplSimd_PMove::WD(const xRegisterSSE &to, const xIndirect64 &from) const {
...
//        Destination[96..127] = Source[48..63];
    ...
    if(this->OpcodeBase == 0x2038)
    {
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            g_Emitter.SXTH(l_Dest, Arm64Gen::ARM64Reg::X23);

            g_Emitter.LSR(Arm64Gen::ARM64Reg::X23, Arm64Gen::ARM64Reg::X23, 16);

            g_Emitter.SXTH(Arm64JitConstants::SCRATCH2_64, Arm64Gen::ARM64Reg::X23);
    ...
    if(this->OpcodeBase == 0x3038)
    {
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            g_Emitter.UXTH(l_Dest, Arm64Gen::ARM64Reg::X23);

            g_Emitter.LSR(Arm64Gen::ARM64Reg::X23, Arm64Gen::ARM64Reg::X23, 16);

            g_Emitter.UXTH(Arm64JitConstants::SCRATCH2_64, Arm64Gen::ARM64Reg::X23);
...
//
    ...
    void MOVDZXInternal(u32 prefix, u32 opcode, const xRegisterSSE &to, const xIndirectVoid &from)
    {
//    DEST[31:0] ← SRC;
...
//    DEST[MAXVL-1:128] (Unmodified)
        ...
        if(prefix == 0x66)
        {
            if(opcode == 0x6e)
            {
                ...
                g_Emitter.LDR(Arm64Gen::ARM64Reg::W21, src);

                g_Emitter.STP(Arm64Gen::INDEX_UNSIGNED, Arm64Gen::ARM64Reg::X21, Arm64Gen::ARM64Reg::ZR, Arm64JitConstants::SCRATCH1_64, 0);
            }
            else
                throw L"Unimplemented!!!";
        } else
...
__fi void xMOVDZX(const xRegisterSSE &to, const xIndirectVoid &src) { MOVDZXInternal(0x66, 0x6e, to, src); }
...
//
    ...
    void moveSingleValue(u32 prefix, u32 opcode, const xRegisterSSE &to, const xIndirectVoid &from)
    {
//        DEST[31:0] ←SRC[31:0]
//        DEST[MAXVL-1:32] (Unmodified)
    ...
    void moveSingleValue(u32 prefix, u32 opcode, const xRegisterSSE &to, const xRegisterSSE &from)
    {
...
//                g_Emitter.MOVI2R(Arm64JitConstants::SCRATCH1_64, (u64)to.getData());
//
//                setAddress(Arm64JitConstants::SCRATCH2_64, from);
//
//                g_Emitter.LDR(Arm64Gen::ARM64Reg::W21, Arm64JitConstants::SCRATCH2_64);
//
//                g_Emitter.STP(Arm64Gen::INDEX_UNSIGNED, Arm64Gen::ARM64Reg::X21, Arm64Gen::ARM64Reg::ZR, Arm64JitConstants::SCRATCH1_64, 0);
...
//            Destination[0..63] = Source[0..63];
            ...
            if(opcode == 0x10)
            {
                ...
                g_Emitter.LDR(Arm64Gen::ARM64Reg::X21, Arm64JitConstants::SCRATCH2_64);
...
#define IMPLEMENT_xMOVS(ssd, prefix)                                                                                   \
    ...
    {                                                                                                                  \
        if (to != from)                                                                                                \
            moveSingleValue(prefix, 0x10, to, from);                                                                        \
    }                                                                                                                  \
    __fi void xMOV##ssd##ZX(const xRegisterSSE &to, const xIndirectVoid &from) { moveSingleValue(prefix, 0x10, to, from); } \
...
__fi void xMOVMSKPS(const xRegister32 &to, const xRegisterSSE &from)
{
...
//        FI;
        ...
        g_Emitter.LSR(Arm64Gen::ARM64Reg::X23, Arm64Gen::ARM64Reg::X23, 31);

        g_Emitter.UBFX(getXReg(to), Arm64Gen::ARM64Reg::X23,  0, 1);

        g_Emitter.LSR(Arm64Gen::ARM64Reg::X23, Arm64Gen::ARM64Reg::X23, 32);

        g_Emitter.BFI(getXReg(to), Arm64Gen::ARM64Reg::X23,  1, 1);



        g_Emitter.LSR(Arm64Gen::ARM64Reg::X24, Arm64Gen::ARM64Reg::X24, 31);

        g_Emitter.BFI(getXReg(to), Arm64Gen::ARM64Reg::X24,  2, 1);

        g_Emitter.LSR(Arm64Gen::ARM64Reg::X24, Arm64Gen::ARM64Reg::X24, 32);

        g_Emitter.BFI(getXReg(to), Arm64Gen::ARM64Reg::X24,  3, 1);
    }
