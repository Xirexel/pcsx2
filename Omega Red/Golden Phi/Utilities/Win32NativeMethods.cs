/*  Golden Phi - Client PS2 Emulator for PCs
*
...
namespace Golden_Phi.Utilities
{
    [ComImport]
    ...
    class Native
    {
        ...
        {
            var lBrowser = Native.GetDefaultBrowserPath();

            lBrowser.Arguments = a_url;

            var lbrowser = System.Diagnostics.Process.Start(lBrowser);
            ...
            //dispatcherTimer.Tick += (sender1, e1) =>
            //{
            ...
            //        {
            //            if (ProcessIsBrowser(proc, lProcessName))
            //            {
