...
namespace Golden_Phi.Tools.Savestate
{
    class SStates
    {
        ...
        public SaveStateInfo readData(string a_disk_serial, string a_file_path, int a_value, bool a_isAutosave = false, bool a_isIsQuicksave = false, int a_DecodePixelWidth = 100)
        {
            ...
            l_result.DiscSerial = a_disk_serial;
