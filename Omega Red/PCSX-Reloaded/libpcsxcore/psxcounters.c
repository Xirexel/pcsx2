...
{
    ZeroMemory(&rcnts, sizeof(rcnts));
    ZeroMemory(&hSyncCount, sizeof(hSyncCount));
    ZeroMemory(&spuSyncCount, sizeof(spuSyncCount));
    ZeroMemory(&psxNextCounter, sizeof(psxNextCounter));
    ZeroMemory(&psxNextsCounter, sizeof(psxNextsCounter));
}
